...
- (void)setUser:(User *)user
{
    ...
    // Avatar;
    [imgForAvatar setImageWithURL:[NSURL URLWithString:self.user.avatar] placeholderImage:nil];
    
    // Name;
    lblForName.text = self.user.name;
    
    // Repost;
    [btnForRepost setTitle:[NSString stringWithFormat:@"%ld", (long)self.user.posts] forState:UIControlStateNormal];
    [self alignTextAndImageOfButton:btnForRepost];
    
    // Favorite;
    [btnForFavorite setTitle:[NSString stringWithFormat:@"%ld", (long)self.user.favorites] forState:UIControlStateNormal];
    [self alignTextAndImageOfButton:btnForFavorite];
    
    // Follow;
    [btnForFollow setTitle:[NSString stringWithFormat:@"%ld", (long)self.user.follows] forState:UIControlStateNormal];
