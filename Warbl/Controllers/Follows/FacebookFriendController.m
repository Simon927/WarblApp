...
//
// --- Headers ---;
#import "FacebookFriendController.h"
#import "FollowCell.h"
#import "MoreCell.h"
...
// --- Defines ---;
// FacebookFriendController Class;
@interface FacebookFriendController () <FollowCellDelegate>
{
...
@implementation FacebookFriendController

// Functions;
#pragma mark - FacebookFriendController
...
- (void)loadFollows
{
    ...
    // Get;
    [APIClient getFacebookFriends:last count:DEFAULT_COUNT completion:^(NSArray *follows) {
        // Set;
